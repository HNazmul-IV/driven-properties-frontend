<script>
    ...
    import DSliders from '$lib/ru/includes/property-details/leftSlide/sliders.svelte';
    import PropertySpcs from '$lib/ru/includes/property-details/leftSlide/propertyspcs.svelte';
    import PropertTxtContent from '$lib/ru/includes/property-details/leftSlide/propertContent.svelte';
    import PropertVisit from '$lib/ru/includes/property-details/leftSlide/propertVisit.svelte';
    import Agents from '$lib/ru/includes/property-details/rightSide/agents.svelte';
    import SimilarProperty from '$lib/ru/includes/property-details/rightSide/similarProperty.svelte';
