        ...
        <div class="container">
            <div class="row" id="Dsk">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>LIEUX POPULAIRES SUR DUBAI</h4>
                    <ul>
                        {#each POPULARDUBAIAREAS as PDAS }
                            {#if PDAS.showPopularDubaiArea === 'Yes'}
                                <li><i class="bx bx-chevron-right"></i> <a sveltekit:reload href="/fr/explore/dubai-properties-areas/{PDAS.pcslug}"> {PDAS.pctitle_fr}</a></li>
                            {/if}
                        {/each}
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>LIENS RAPIDES</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="/sales/buy-ready-properties/sale-apartments">Biens immobiliers pour vente</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>CONCERNANT LA SOCIETE</h4>
                    <ul>
                        {#each FooterMenus as ACompany }
                            {#if ACompany.showAboutCompany === 'Yes'}
                                <li><i class="bx bx-chevron-right"></i> <a href="/fr/{ACompany.showAboutURL}"> {ACompany.name_fr}</a></li>
                            {/if}
                        {/each}
