...
<section id="services" class="services section-bg">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title mb-4">
            <h2>{pageContent.name_fr ? pageContent.name_fr :'Driven Properties International'}</h2>
        </div>
                ...
                <div class="mb-4 col-lg-3 col-xl-3 col-md-6 aos-animate" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <div class="icon">
                            ...
                            <p>{@html internationalteams.tmslug_fr ? internationalteams.tmslug_fr :'China'}</p>
                        </div>

                        <div class="icon-msg">
                            <h4>{@html internationalteams.fullname_fr ? internationalteams.fullname_fr : 'Thomas Wan'}</h4> 
                            <p>{@html internationalteams.jobtitle_fr ? internationalteams.jobtitle_fr : 'Associate Partner'}</p>
