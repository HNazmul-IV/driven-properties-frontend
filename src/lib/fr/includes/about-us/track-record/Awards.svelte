...
<section id="drv-bread" class="section-bg">
    <BreadCrumb 
        ...
        LinkThree={pageSlug[3]} headings={pageSlug[4]+" - "+pageContent.name_fr}
...
<section id="services" class="services section-bg">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title mb-4">
            <h2>{@html pageContent.name_fr ? pageContent.name_fr : "Best Real Estate Company"}</h2>
        </div>
                ...
                {#if (awards.awdyear >= LFYears) && (awards.awdimgname !== null) }
                    <div class="mb-4 col-lg-3 col-xl-3 col-md-6 aos-animate" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            ...
                            <div class="icon-msg">
                                <h4>{@html awards.awdtitle_fr ? awards.awdtitle_fr: 'Dubai Large, No 1 Best Quality Brokerage'}</h4> 
                                <p>
                                    {@html awards.awdcompany_fr ? awards.awdcompany_fr: 'Property Finder'}
                                    - 
                                ...
                                <ul class="MyAwards">
                                    {#each Awards as awards (awards.id)}
                                        {#if (awards.awdyear == date.getFullYear() - curYear)}
                                            <li>
                                                {@html awards.awdtitle_fr ? awards.awdtitle_fr: 'Appreciation Award '}
                                                - 
                                                <em>
                                                    {@html awards.awdcompany_fr ? awards.awdcompany_fr: 'Nshama'}
                                                </em>
                                            </li>
                                        {/if}
                                    {/each}
