...
<section id="about" class="about">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title">
            ...
            <h2>{@html pageContent.name_fr ? pageContent.name_fr : "Preferred Partners" }</h2>
        </div>
            ...
            <div class="mb-4 col-lg-4 col-xl-4 col-md-6 d-flex flex-row justify-content-center align-items-stretch order-2 order-lg-1 aos-animate" data-aos="zoom-in" data-aos-delay="100">
                <div class="content"> 
                    ...
                    <div class="content-details fadeIn-bottom">
                        <h3 class="content-title">{PreferredPartners.pfpname_fr}</h3>
                        <p class="content-text">
                            <i class="fa fa-map-marker"></i>
                            {@html PreferredPartners.pfpdescription_fr}
                        </p>
