...
<section id="services" class="services section-bg">
    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title mb-4">
            <h1>{pageContent.name_fr ? pageContent.name_fr : "Leadership Team" }</h1>
        </div>
        ...
        <div class="row">
            <div class="mb-4 col-12 col-md-3 aos-animate" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="icon-box">
                    <div class="icon">
                        <img src="{OurFounder.tmimgname ? "/l9images/teams/"+OurFounder.tmimgname : "/assets/img/team/gen_3_4061.jpg" }" alt="{OurFounder.fullname}" class="bx bxl-dribbble" />
                    </div>

                    <div class="icon-msg">
                        <h4>{@html OurFounder.fullname_fr ? OurFounder.fullname_fr : 'Abdullah Alajaji'}</h4> 
                        <p>{@html OurFounder.jobtitle_fr ? OurFounder.jobtitle_fr : 'Founders'}</p>
                    </div>
                </div>
            ...
            <div class="mb-4 col-12 col-md-6 aos-animate txtContent" data-aos="zoom-in" data-aos-delay="200">
                {@html OurFounder.jobdescription_fr ? OurFounder.jobdescription_fr : "Content Required" } 
            </div>
            ...
            {#each LocalTeams as localTeams (localTeams.id)}
                <div class="mb-4 col-lg-3 col-xl-3 col-md-6 aos-animate" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box">
                        ...
                        <div class="icon">
                            <img src="{localTeams.tmimgname ? "/l9images/teams/"+localTeams.tmimgname : "/assets/img/team/gen_747.jpg" }" alt="{localTeams.fullname}" class="bx bxl-dribbble" />
                        </div>

                        <div class="icon-msg">
                            <h4>{@html localTeams.fullname_fr ? localTeams.fullname_fr : 'Khadija El Otmani'}</h4> 
                            <p>{@html localTeams.jobtitle_fr ? localTeams.jobtitle_fr : 'Managing Partner of Driven Holiday Homes'}</p>
                        </div>
                    </div>
                </div>
