<script>
    ...
    onMount(async () => {        
        ...
        oneURL = !(oneURL) ? `http://127.0.0.1:8000/api/getAllBedRoom` : `${baseURL}/getAllBedRoom`;
        ...
        twoUrl = !(twoUrl) ? `http://127.0.0.1:8000/api/getAllPropertyType` : `${baseURL}/getAllPropertyType`;
        ...
        threeURL = !(threeURL) ? `http://127.0.0.1:8000/api/getAllPropertyStatus` : `${baseURL}/getAllPropertyStatus`;
            ...
            <div class="row BxInfo-row">
                <div class="col-lg-2 col-md-6">
                    <div class="input-group">
                        <select id="status" name="prostatus" class="form-select fsr" bind:value="{prostatus}">
                ...
                <div class="col-lg-4  col-md-6 mt-2">
                    <select id="protype" name="protype" class="form-select frsone" bind:value="{protype}">
                ...
                <div class="col-lg-4  col-md-6 mt-2">
                    <select id="bedrooms" name="bedrooms" class="form-select frsone" bind:value="{bedrooms}">
