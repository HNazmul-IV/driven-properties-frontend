<script>
    ...
    import LeadFormRight from '$lib/ar/commons/LeadFormRight.svelte'
    ...
    <div class="container ">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb d-flex flex-row bd-highlight">
                ...
                <li class="breadcrumb-item bd-highlight active" aria-current="page">{@html pageContent.name_ar ? pageContent.name_ar : "Corporate Occupier Services" } </li>
            </ol>
        </nav>
        <h1>{pageContent.name_ar ? pageContent.name_ar : "Corporate Occupier Services" }</h1>
    </div>
    <div class="hero-imgbanner" style="background-image:url({pageContent.imgname ? "/l9images/banners/"+pageContent.imgname : "/assets/images/gen_4413145.jpg" });"></div>
    <LeadFormRight/>
</section>
...
<section id="about" class="about">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <!--div class="section-title">
            <h2>{@html pageContent.name_ar ? pageContent.name_ar : "Corporate Occupier Services" }</h2>
        </div-->
