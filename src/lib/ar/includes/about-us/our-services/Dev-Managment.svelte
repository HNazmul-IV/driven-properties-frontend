    ...
    <div class="container ">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb d-flex flex-row bd-highlight">
                ...
                <li class="breadcrumb-item bd-highlight active" aria-current="page">{@html pageContent.name_ar ? pageContent.name_ar : "Development Management" }</li>
            </ol>
        </nav>
        <h1>{@html pageContent.name_ar ? pageContent.name_ar : "Development Management" }</h1>
    </div>

    <div class="hero-imgbanner" style="background-image:url({pageContent.imgname ? "/l9images/banners/"+pageContent.imgname : "/assets/images/gen_4413141.jpg" });"></div>
    <LeadFormLeft/>
</section>
