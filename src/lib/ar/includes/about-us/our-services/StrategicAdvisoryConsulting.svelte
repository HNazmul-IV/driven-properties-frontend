    ...
    <div class="container ">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb d-flex flex-row bd-highlight">
                ...
                <li class="breadcrumb-item bd-highlight"><a href="/">Our Services</a></li>
                <li class="breadcrumb-item bd-highlight active" aria-current="page">{@html pageContent.name_ar ? pageContent.name_ar : "Strategic Advisory and Consulting" }</li>
            </ol>
        </nav>
        <h1>{@html pageContent.name_ar ? pageContent.name_ar : "Strategic Advisory and Consulting" }</h1>
    </div>
    <div class="hero-imgbanner" style="background-image:url({pageContent.imgname ? "/l9images/banners/"+pageContent.imgname : "/assets/images/gen_4413142.jpg" });"></div>    
    <LeadFormLeft/>
</section>
...
<section id="about" class="about">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <!--div class="section-title">
            <h2>{@html pageContent.name_ar ? pageContent.name_ar : "Strategic Advisory and Consulting" }</h2>
        </div-->
