...
<section id="services" class="services section-bg">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title mb-5">
            <h2 class="mb-4">{@html pageContent.name_ar}</h2>
        </div>
        ...
        <div class="row">
            {#each DAGs as DubaiAreaGuides, i }
                ...
                <div class="mb-4 col-lg-4  col-md-4 col-12 aos-animate" data-aos="zoom-in" data-aos-delay="100">
                    <a href="/ar/{pageSlug[2]}/{pageSlug[3]}/{DubaiAreaGuides.pcslug}" class="Dag">
                        <div class="icon-box">
                            ...
                            <div class="icon-msg">
                                ...
                                <p>{DubaiAreaGuides.pcmetatitle_ar}</p>
                            </div>
                        </div>
                    </a>
                </div>
...
<section id="why-us" class="why-us section-bg">
    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
        <div class="row content">
            <div class="col-lg-12 pt-4 pt-lg-0">
                {@html pageContent.description2_ar ? pageContent.description2_ar : "Content Required" } 
            </div>
        </div>
    </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div id="accordion-list-5" class="collapse" data-bs-parent=".accordion-list" style="">
                            <p>A: People are interested in owning the new residential projects in Abu Dhabi because of the excellent inarastructure, stable real estate, booming economy, and outstanding living conditions in the city.</p>
                        </div>
                    </li>
