...
<section id="drv-bread" class="section-bg">
    <BreadCrumb LinkOne={pageSlug[1]} LinkTwo={pageSlug[2]} LinkThree={pageSlug[3]} headings={pageSlug[3]+" - "+pageContent.name} Bdtype={3}/>
</section>
...
<section id="services" class="services section-bg">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title mb-4">
            <h2>{@html pageContent.name ? pageContent.name : "Best Real Estate Company"}</h2>
        </div>
                ...
                {#if (awards.awdyear >= LFYears) && (awards.awdimgname !== null) }
                    <div class="mb-4 col-lg-3 col-xl-3 col-md-6 aos-animate" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            ...
                            <div class="icon-msg">
                                <h4>{@html awards.awdtitle ? awards.awdtitle: 'Dubai Large, No 1 Best Quality Brokerage'}</h4> 
                                <p>
                                    {@html awards.awdcompany ? awards.awdcompany: 'Property Finder'}
                                    - 
                                ...
                                <ul class="MyAwards">
                                    {#each Awards as awards (awards.id)}
                                        {#if (awards.awdyear == date.getFullYear() - curYear)}
                                            <li>
                                                {@html awards.awdtitle ? awards.awdtitle: 'Appreciation Award '}
                                                - 
                                                <em>
                                                    {@html awards.awdcompany ? awards.awdcompany: 'Nshama'}
                                                </em>
                                            </li>
                                        {/if}
                                    {/each}
