<script>
    ...
    export let searchKey2;
    
    
  
    onMount( async()=>{  

        console.log(searchKey2, projectName);
        const response = await fetch(`${baseURL}/getAllProperties`);
        //const response = await fetch(`${baseURL}/getAllBySlugProperties/${searchKey2}`);
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-5">                    
                    <h3 class="text-uppercase">OFF PLAN PROJECTS IN {projectName} </h3>
                </div>
            </div>   
                        ...
                        <a href="/" class="MyProList">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="card-title">                                
                                        {@html MFData ? MFData.Property_Name : "Project Name Area"}
                                    </h6>
            ...
            <div class="row">
                <div class="col-lg-12 mt-3 mb-3">
                    <span class="d-flex flex-row-reverse">
                        <a href="/explore/new-development-dubai" class="btn-learn-more-two">More Offplan Projects</a>
                    </span>
                </div>
            </div>
