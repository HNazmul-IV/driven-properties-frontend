<script>
    ...
    import ListingListItem from '$lib/includes/sales-php/listing.svelte';
    ...
    onMount(()=> {
        console.log('apartment list mount');
                ...
                {#each result as listing , i}
                    ...
                    {#if listing.Published === 'Yes'}
                        <ListingListItem 
                            ...
                            agentNumber ={(listing.Property_Name)}
                            building={(listing.Property_Title )} 
                            objectID = {listing.id}
