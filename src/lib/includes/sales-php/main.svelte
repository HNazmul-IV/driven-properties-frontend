<script>
  ...
  import Mapbox from '$lib/includes/sales-php/map.svelte';
  ...
  import ApartmentsList from '$lib/includes/sales-php/apartmentslist.svelte';    
  ...
  onMount(async ()=>{ 
      console.log('onmount main offplan');
  ...
  <slot>
    <div class="container aos-init aos-animate" data-aos="fade-up">
      <div class="section-title">
        <h2 class="mb-4">{@html pageContent.name ? pageContent.name : "Area Guide" }</h2>
      </div>
    </div>
  </slot>
<!-- {/if} -->
