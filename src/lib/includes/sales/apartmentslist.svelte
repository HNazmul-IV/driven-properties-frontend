<script>
    ...
    // var placeholder = require('placeholder.jpg');
    ...
    let isData = false;
    let newList = [];
    let thumbnail = '/assets/images/uae-flag.png';
...
<!-- images={listing.Images.image[0] !== undefined ? listing.Images.image[0] : thumbnail} -->
