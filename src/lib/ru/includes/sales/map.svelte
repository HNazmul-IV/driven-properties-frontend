                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-sm-12 px-2 mb-2">
                                        ...
                                        <div class="d-flex flex-row bd-highlight mb-1">
                                            <div class="p-2 bd-highlight">${bigPopupmarker.properties.UnitType==='Apartment'? 'Wohnung': 'Villa'}</div>
                                            
                                            <div class="p-2 bd-highlight"><i class="bx bx-building-house"></i></div>
                                            <div class="p-2 bd-highlight">${bigPopupmarker.properties.BedRooms.split('-')[0]} Betten</div>
                                            <div class="p-2 bd-highlight"><i class="bx bx-building-house"></i></div>
                                            <div class="p-2 bd-highlight">${bigPopupmarker.properties.BathRooms} Badezimmer</div>
                                        </div>

                                        <h6>${bigPopupmarker.properties.price} EUR</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            for(let d=0; d<length; d++){
                geojson = {
                    ...
                    'features': [{
                        'type': 'Feature',
                        'properties': {
                            'description': `<strong id="${data[d].objectID}" >${covertToIntCurrancy(data[d].Price  *.25)} EUR</strong>`,
                            'active': `${data[d].Published}`,
                            'price': `${CurrancySBC(data[d].Price *.25)}`,
                            'ID': data[d].objectID,
                            'Image': data[d].Images,
