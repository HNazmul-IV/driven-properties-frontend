...
<script>
  ...
  const getPageName = (PageNames)=>{
    ...
    if(MyArray.length !== 0 ){
      ...
      else {SearchData = ["Price", "No_of_Rooms","Bedrooms", "Unit_Type", "Ad_Type", "Community", "Sub_Community", "Property_Title", "Property_Name", "objectID"];}
      ...
      // console.clear();
      // SearchData = ["Price", "No_of_Rooms","Bedrooms", "Unit_Type", "Ad_Type", "Community", "Sub_Community", "Property_Title", "Property_Name", "objectID"];
      // index.setSettings({ 
