...
<script>
  ...
  import Mapbox from '$lib/ru/includes/sales/map.svelte';
  import BreadCrumb from '$lib/ru/commons/breadcrumb.svelte';
  import Search from '$lib/ru/includes/sales/search.svelte';
  import ApartmentsList from '$lib/ru/includes/sales/apartmentslist.svelte';   

  import SEOTools from '$lib/commons/SEOText.svelte';
  
  import MOBMapbox from '$lib/ru/includes/sales/map-mobile.svelte';
  import MOBApartmentsList from '$lib/ru/includes/sales/apartmentslist-mob.svelte';
  import Loader from '../../../loader/loader.svelte';
    import LeadFormLeft from '../../../commons/LeadFormLeft.svelte';
  ...
  updateFunction = (newBoundingBox = null, pageNumber=1)=>{
  ...
  const numPagination = (event) =>{
      ...
      console.log(typeof paginationNumber, paginationNumber);
      pageNumber = paginationNumber;
      updateFunction(null,paginationNumber);
  } // end numPagination  
