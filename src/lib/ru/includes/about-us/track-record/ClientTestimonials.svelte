...
<section id="drv-bread" class="section-bg">
    <BreadCrumb LinkOne={pageSlug[2]} LinkTwo={pageSlug[3]} LinkThree={pageSlug[4]} headings={pageContent.name} Bdtype={3}/>
</section>
...
<section id="team" class="team section-bg">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>{@html pageContent.name_ru ? pageContent.name_ru : "CLIENT TESTIMONIALS"}</h2>
        </div>

        <div class="row mt-5">
            {#each Testimonials as testimonials (testimonials.id)}
                {#if testimonials.clientname_ru !== null}
                
                    <div class="mb-5 col-lg-6 col-md-6 col-12 text-center aos-animate" data-aos="zoom-in" data-aos-delay="{testimonials.id}00">
                        <div class="icon-box">

                            <div class="icon">                            
                                <img src="{testimonials.tsimgname ? "https://dev.drivenproperties.ru/theme/assets/images/testimonials/"+ testimonials.tsimgname :'/assets/img/testimonials/gen_1067.jpg'}"  alt="{testimonials.clientname}" />
                                <!--p>Property Finder - 2021</p-->
                            </div>
                            <div class="icon-msg">
                                <p> 
                                    <span><i class="FSbx bx bxs-quote-left"></i></span>
                                    {@html testimonials.tsjobdescription ? testimonials.tsjobdescription:''} 
                                    <span><i class="FSbx bx bxs-quote-right"></i></span>
                                </p>
                                <h4>{testimonials.clientname_ru ? testimonials.clientname_ru :''}</h4> 
                            </div>
                        </div>
                    </div>
