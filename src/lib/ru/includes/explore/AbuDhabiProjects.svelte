...
<section id="services" class="services section-bg">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title mb-5">
            <h2 class="mb-4">{@html pageContent.name_ru}</h2>
        </div>
                ...
                <div class="mb-4 col-lg-4  col-md-4 col-12 aos-animate" data-aos="zoom-in" data-aos-delay="100">
                    <a href="/fr/{pageSlug[2]}/{pageSlug[3]}/{DubaiAreaGuides.pcslug}" class="Dag">
                        <div class="icon-box">
                            ...
                            <div class="icon-msg">
                                <h4>{DubaiAreaGuides.pctitle_ru}</h4>
                                <p>{DubaiAreaGuides.pcmetatitle_ru}</p>
                            </div>
                        </div>
                    </a>
                </div>
...
<section id="why-us" class="why-us section-bg">
    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
        <div class="row content">
            <div class="col-lg-12 pt-4 pt-lg-0">
                {@html pageContent.description2_ru ? pageContent.description2_ru : "Content Required" } 
            </div>
        </div>
    </div>
