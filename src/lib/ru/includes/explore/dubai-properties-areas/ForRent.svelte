                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-12 mb-1 mt-1">
                            <h5>
                                {CurrancySBC(MFData.Price*0.27)} USD
                            </h5>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-6">
                            ...
                            <!--i class="bx bxs-map-pin MyPin"></i-->
                            {@html MFData.No_of_Rooms ?  MFData.No_of_Rooms : MFData.Bedrooms ?  MFData.Bedrooms : "1"} Lit
                        </div>                          

                        <div class="col-md-5 col-lg-5 col-6">
                            <i class="bx bx-building-house"></i> 
                            <!--i class="bx bxs-map-pin MyPin"></i-->
                            {@html MFData.No_of_Bathroom ?  MFData.No_of_Bathroom : "1"}  Bain
                        </div>
