<script>
    ...
    import HeaderSearchForm from '$lib/ru/headers/header-search-form.svelte';
    ...
    afterUpdate(()=> {
        ...
        pageSlug.length===7?isDynamicListPage = true: isDynamicListPage=false;
...
<section id="drv-bread" class="section-bg {isDynamicListPage?'dynamicList':''}">
