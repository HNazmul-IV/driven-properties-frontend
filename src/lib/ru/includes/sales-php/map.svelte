<script>
    ...
    import { baseURL, origin } from "../../../../base-url.js";
    ...
    const dataUpdate = async () => {
        console.log('dataUpdate map.svelte sales-php');
    ...
    const getPropertiesMarkerMap = (map) => {
        ...
        for (const property of properties) {
            if(property.Price !== null && property.Property_Title){
            // if(property.Price !== null){
                const description = `
                    <div class="container g-0">
                        <div class="row g-0">
                            <div class="col-12 mb-2"><img  src="${origin}/theme/assets/images/community/${property.Prothbimgname}" class="img-fluid myImgPopup" /></div>
                                <div class="col-sm-12 px-2 mb-2">
                                    ...
                                    <div class="d-flex flex-row bd-highlight justify-content-between mb-1">
                                        <div class="pt-2 bd-highlight"><strong>Price:</strong> ${covertToIntCurrancy(property.Price *.25)} EUR</div>
                                    </div>
                ...
                el.textContent= covertToIntCurrancy(property.Price *.25)+' EUR';
