<script>
    ...
    //import Country from '$lib/countryPhoneCodes.json'

    let Country =[];
    onMount(async () => { 
        let ApiUrl = '/others/countryPhoneCodes.json';
...
<div class="container" id="frmRight">
    <div class="row">
                ...
                <!-- <div class="col"> -->
                    ...
                    <div class="d-flex flex-row ">
                        ...
                        <div class="p-0  col-7">
                            ...
                            <input type="text" class="form-control" id="phone" placeholder="Phone / Mobile" required/>
                        </div>
                    </div>
                <!-- </div> -->
...
<style>
    ...
    #frmRight{position:absolute; top:33vh; left:5vw;}
    #frmRight .col-lg-3, .col-md-3{
        width: 25%; background-color: rgb(0 0 0 / 60%); color: #fff; padding: 40px 20px;
    }
    #frmRight .col-lg-4, .col-md-4{
        width: 34%; background-color: rgb(0 0 0 / 60%); color: #fff; padding: 40px 20px;
    }
    #frmRight .frmDetails >h3{font-size: 1.5rem; margin: 0 0 15px 0; text-align: center;}
    ...
    @media only screen and (max-width: 768px) {
        #frmRight{top:40%; left:2vw !important;}
    }
